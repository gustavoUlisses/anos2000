type LoginWindowToolbarProps = {
  onClose: () => void;
  onMinimize: () => void;
};

export function LoginWindowToolbar({ onClose, onMinimize }: LoginWindowToolbarProps) {
  return (
    <div className="d-flex justify-content-between align-items-center handle">
      ...
      <div className="d-flex gap-2">
        <svg role="button" onClick={onMinimize} xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="white" className="bi bi-dash-lg" viewBox="0 0 16 16">
        ...
        <svg role="button" onClick={onClose} xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="white" className="close-btn bi bi-x-lg" viewBox="0 0 16 16">
