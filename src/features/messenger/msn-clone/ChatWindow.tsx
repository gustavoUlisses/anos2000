    ...
    <div className="chat-window position-relative" id="chatWindow" ref={chatWindowRef}>
      <div className="d-flex justify-content-between align-items-center handle px-2">
        ...
        <div className="d-flex gap-2">
          <svg role="button" onClick={onMinimize} xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="#787878" className="window-action" viewBox="0 0 16 16">
            <path fillRule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 2 8" />
          </svg>
          <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="#787878" className="window-action" viewBox="0 0 16 16">
          ...
          <svg role="button" onClick={onClose} xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="#787878" className="close-btn window-action" viewBox="0 0 16 16">
