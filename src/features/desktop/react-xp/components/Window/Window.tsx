...
const Window = ({ ...props }: WindowProps) => {
    ...
    const { title, icon, iconLarge, showOnTaskbar = true, width = 500, height = 350, top = 75, right = undefined, bottom = undefined, left = 100, resizable = true, maximizable = true } = { ...applications[appId], ...props };
