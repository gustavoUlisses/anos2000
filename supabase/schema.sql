...
create table if not exists public.profiles (
  ...
  avatar_url text not null default '/msn/images/user.png',
...
alter table public.profiles add column if not exists avatar_url text not null default '/msn/images/user.png';
